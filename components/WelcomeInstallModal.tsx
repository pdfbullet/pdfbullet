        ...
        <div className="fixed inset-0 bg-black/70 z-[100] flex items-center justify-center p-4 animate-fade-in-down" onClick={handleClose}>
            <div className="bg-white dark:bg-black w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden relative" onClick={e => e.stopPropagation()}>
                <div className="p-8 text-center">
                    ...
                    <h2 className="text-3xl font-extrabold text-gray-800 dark:text-gray-100">Welcome to Pdf Bullet!</h2>
                 ...
                 <button onClick={handleClose} className="absolute top-3 right-3 text-gray-400 hover:text-gray-800 dark:hover:text-white p-1 rounded-full transition-colors" aria-label="Close">
