...
import { CopyIcon, CheckIcon, CloseIcon } from './icons.tsx';
...
const QrCodeModal: React.FC<QrCodeModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-black w-full max-w-md rounded-xl shadow-2xl transform transition-all animate-fade-in-down"
      ...
      >
        <header className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-t-xl border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <button onClick={onClose} className="p-1 rounded-full text-gray-500 hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 transition-colors" aria-label="Close modal">
