...
const TeamPage: React.FC = () => {
    ...
    const handleInviteClick = () => {
        // FIX: Replace deprecated 'isPremium' with 'isToolsPremium'.
        if (user?.isToolsPremium) {
    ...
    return (
        <>
            ...
            {/* FIX: Replace deprecated 'isPremium' with 'isToolsPremium'. */}
            { !user?.isToolsPremium && <UpgradeModal isOpen={isUpgradeModalOpen} onClose={() => setIsUpgradeModalOpen(false)} /> }
            {/* FIX: Replace deprecated 'isPremium' with 'isToolsPremium'. */}
            { user?.isToolsPremium && <InviteMembersModal isOpen={isInviteModalOpen} onClose={() => setIsInviteModalOpen(false)} /> }
        </>
    );
};
