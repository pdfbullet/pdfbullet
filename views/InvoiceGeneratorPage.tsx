...
import { DownloadIcon, PlusIcon, EditIcon, TrashIcon, UploadIcon, GmailIcon, WhatsAppIcon, MessengerIcon, ShareIcon, PrintIcon, StarIcon, LockIcon, GridIcon, DollarIcon, BrainIcon, LeftArrowIcon } from '../components/icons.tsx';
...
const AIItemsModal: React.FC<{
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (!res.ok) throw new Error(result.error || 'Failed to generate items.');
