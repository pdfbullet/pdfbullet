...
const HomePage: React.FC = () => {
    ...
    const imageToolIds = useMemo(() => new Set(TOOLS.filter(t => t.api?.category === 'image' || ['jpg-to-pdf', 'psd-to-pdf', 'pdf-to-jpg', 'pdf-to-png'].includes(t.id)).map(t => t.id)), []);
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <section className={`relative text-center overflow-hidden hero-background transition-all duration-300 ${user ? 'py-4' : 'pt-4 pb-2 md:pt-6 md:pb-2'}`}>
            {/* Full-width decorative red SVG background */}
            <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden flex justify-center items-center">
                <svg className="w-[100vw] h-full min-w-[100vw] opacity-25 dark:opacity-20 left-1/2 -translate-x-1/2 absolute" viewBox="0 0 1440 320" preserveAspectRatio="none" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill="url(#heroRedGradient)" d="M0,160L48,176C96,192,192,224,288,213.3C384,203,480,149,576,144C672,139,768,181,864,197.3C960,213,1056,203,1152,181.3C1248,160,1344,128,1392,112L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
                    <defs>
                        <linearGradient id="heroRedGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="#FF416C" stopOpacity="0.4" />
                            <stop offset="50%" stopColor="#FF4B2B" stopOpacity="0.25" />
                            <stop offset="100%" stopColor="#FF416C" stopOpacity="0.05" />
                        </linearGradient>
                    </defs>
                </svg>
            </div>
            <div className="px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <section id="all-tools" className="pb-24">
            <div className="px-6 sm:px-8 lg:px-12">
                {activeCategory === 'workflows' ? (
                    ...
                    <div className="mt-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
        ...
        <section className="py-20 overflow-hidden bg-gray-50 dark:bg-black">
            ...
            <div className="mt-12 relative">
                <div className="md:overflow-x-auto no-scrollbar md:mx-auto">
            ...
            <div className="px-6 sm:px-8 lg:px-12">
                ...
                <div className="mt-8 flex justify-center">
                    <a href="https://www.trustpilot.com/review/ilovepdfly.com" target="_blank" rel="noopener noreferrer" title="Review PDFBullet on Trustpilot">
                        <img 
                            src="https://ik.imagekit.io/fonepay/flipbook%20/trustpilot.png?updatedAt=1762100612831" 
        ...
        <section className="py-20 bg-gray-50 dark:bg-black">
            <div className="px-6 sm:px-8 lg:px-12">
                ...
                <div className="mt-12 bg-white dark:bg-surface-dark p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800">
                    {faqs.map((faq, index) => (
                        <HomeFaqItem 
                            key={index} 
                            item={faq}
