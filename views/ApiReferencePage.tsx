...
const ApiReferencePage: React.FC = () => {
    ...
    const sectionsRefs = useMemo(() => {
        const refs: { [key: string]: React.RefObject<HTMLDivElement> } = {
            ...
            quickstart: React.createRef<HTMLDivElement>(),
            authentication: React.createRef<HTMLDivElement>(),
            'pdf-image': React.createRef<HTMLDivElement>(),
            'request-workflow': React.createRef<HTMLDivElement>(),
            start: React.createRef<HTMLDivElement>(),
            upload: React.createRef<HTMLDivElement>(),
            process: React.createRef<HTMLDivElement>(),
            download: React.createRef<HTMLDivElement>(),
            task: React.createRef<HTMLDivElement>(),
            signatures: React.createRef<HTMLDivElement>(),
            create_signature_request: React.createRef<HTMLDivElement>(),
            list_signatures: React.createRef<HTMLDivElement>(),
            get_signature_status: React.createRef<HTMLDivElement>(),
            get_receiver_info: React.createRef<HTMLDivElement>(),
            download_audit: React.createRef<HTMLDivElement>(),
            download_original_files: React.createRef<HTMLDivElement>(),
            download_signed_files: React.createRef<HTMLDivElement>(),
            fix_receiver_email: React.createRef<HTMLDivElement>(),
            fix_signer_phone: React.createRef<HTMLDivElement>(),
            send_reminders: React.createRef<HTMLDivElement>(),
            void_signature: React.createRef<HTMLDivElement>(),
            increase_expiration_days: React.createRef<HTMLDivElement>(),
            topics: React.createRef<HTMLDivElement>(),
            security: React.createRef<HTMLDivElement>(),
            errors: React.createRef<HTMLDivElement>(),
            testing: React.createRef<HTMLDivElement>(),
            credit_consumption: React.createRef<HTMLDivElement>(),
            webhooks: React.createRef<HTMLDivElement>(),
            fonts_compatibility: React.createRef<HTMLDivElement>(),
        };
        TOOLS.forEach(tool => {
            if(tool.api) refs[tool.id] = React.createRef<HTMLDivElement>();
        });
        return refs;
    }, []);
