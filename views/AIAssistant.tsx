...
import { AIAssistantIcon, FileIcon, UserIcon, PaperAirplaneIcon, CopyIcon, RefreshIcon, MicrophoneIcon, GlobeIcon, StarIcon } from '../components/icons.tsx';
                        ...
                        {mode === 'pdf' && (
                            <div>
                                {!file ? (
                                    <div
                                        {...getRootProps()}
                                        className={`p-10 border-2 border-dashed rounded-lg text-center cursor-pointer transition-colors duration-300 ${isDragActive ? 'border-brand-red bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-brand-red'
                                            }`}
                                    >
                                        <input {...getInputProps()} />
                                        ...
                                        {isPasswordProtected ? (
                                            ...
                                            <div className={`flex flex-col sm:flex-row gap-2 ${isParsingPdf || pdfError ? 'opacity-50 pointer-events-none' : ''}`}>
                                                ...
                                                <button
                                                    ...
                                                    disabled={isPdfLoading || isListening || isParsingPdf || !!pdfError}
                                                    className={`p-3 rounded-md border bg-white dark:bg-black transition-colors flex-shrink-0 ${isListening
