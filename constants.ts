...
import {
  ...
  RepairIcon,
  PageNumbersIcon,
  // FIX: Renamed ScanToPdfIcon to DocumentScannerIcon to match the exported member from icons.tsx.
  DocumentScannerIcon,
  OcrPdfIcon,
  CropPdfIcon,
  ImageIcon,
...
export const blogPosts = [
    ...
    image: 'https://ik.imagekit.io/fonepay/social%20media%20band%20in%20nepal%20pdfbullet.png?updatedAt=1757078313764',
    author: 'The PDFBullet Team',
...
<p>Stop letting CV formatting stand in the way of your career goals. Create a document that makes you stand out and land the interview you deserve. Try our free CV Generator today!</p>`,
        image: 'https://ik.imagekit.io/fonepay/pdfbullet%20blog.png?updatedAt=1753465347545',
        author: 'The PDFBullet Team',
        authorImage: '/logo.svg',
...
<p>Each question comes with the correct answer, so you can check your work immediately. Stop just reading and start actively learning. Turn your study material into an interactive learning experience with the AI Question Generator today!</p>`,
    ...
    {
    slug: 'you-can-now-edit-images-in-pdfbullet',
    title: 'You can now edit images in PDFBullet',
    date: 'August 4, 2025',
    excerpt: 'Exciting news! PDFBullet is expanding beyond PDFs. Discover our powerful new image editing tools, including a one-click Background Remover, designed to streamline your creative workflow. Edit your images and convert them to PDF all in one place.',
...
<img src="https://www.ilovepdf.com/storage/blog/205-1678103763-2.1-iLoveIMG-Edit-tool.png" alt="PDFBullet's Photo Editor" class="my-4 rounded-lg shadow-md" />
<h3>Photopea</h3>
...
<h3>Compress PDF files with PDFBullet</h3>
...
<img src="https://www.ilovepdf.com/storage/blog/205-1678110276-9.-iLovePDF-Compress-%281%29.png" alt="PDFBullet Compress PDF" class="my-4 rounded-lg shadow-md" />
<h3>The PDFBullet Compress Image tool</h3>
...
<h3>The PDFBullet JPG to PDF converter</h3>
<p>Transform your JPG files into professional PDF documents with ease and precision, thanks to PDFBullet's free JPG to PDF converter.</p>
...
<h3>The PDFBullet Watermark tools</h3>
<p>Protect your valuable designs and ensure they are not used without your permission with the PDFBullet Watermark tools. With user-friendly interfaces, adding a custom watermark to your images or PDFs has never been easier.</p>
<p>Overall, it’s recommended that you use the PDFBullet tool for a wider range of features. The free watermark tools allow you to add a text box with editable fonts, sizes, color, and more.</p>
...
<p>That's it! You've successfully edited your PDF without losing quality or wasting time on conversions. Whether you need to correct a small typo, update an address, or revise a paragraph, the PDFBullet Editor is the fastest and easiest way to get it done online.</p>`,
    ...
    {
    slug: 'pdfbullet-web-vs-desktop-vs-mobile-which-is-for-you',
    title: 'PDFBullet Web vs. Desktop vs. Mobile: Which One Is for You?',
    date: 'July 29, 2025',
    excerpt: 'Confused about which PDFBullet version to use? This guide breaks down the key differences between our Web, Desktop, and Mobile platforms. Discover which tool is best for your specific needs, whether you prioritize online convenience, offline power, or on-the-go document management.',
    content: `Choosing the right tool for the job is key to maximizing productivity. At PDFBullet, we offer three powerful platforms designed to fit different workflows: Web, Desktop, and Mobile. Each has its unique strengths, and understanding them will help you manage your documents more effectively than ever before. Let's break down the differences.
...
<p>Many of our users find that a combination of the platforms works best, using each for what it does best. The choice is yours, and no matter which you pick, you'll be equipped with the best tools to handle any PDF task.</p>`,
    ...
    {
    slug: 'introducing-pdfbullet-chatgpt-custom-pdf-gpt',
    title: 'Introducing PDFBullet + ChatGPT: The Custom PDF GPT',
    date: 'July 28, 2025',
    excerpt: 'Meet your new PDF assistant! PDFBullet integrates with ChatGPT, allowing you to summarize, translate, and ask questions about your documents using natural language. Upload any PDF and interact with it like never before, saving time and working smarter.',
    content: `Use ChatGPT as your PDF assistant with PDFBullet—no software needed. Just upload, describe, and go.
