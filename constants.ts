...
import {
  ...
  ZipIcon,
  ResizeIcon,
  PdfReaderIcon, // Added PDF Reader Icon
...
export const TOOLS: Tool[] = [
  ...
  // Business
  {
    id: 'flipbooks',
    title: 'flipbooks',
    description: 'turn your any pdf into flipbooks',
    Icon: BookOpenIcon,
    color: 'bg-teal-500',
    hoverColor: 'hover:bg-teal-600',
    textColor: 'text-teal-600',
  ...
  },
  {
    ...
    description: 'Turn any text into stunning AI-generated images for free.',
    Icon: ImageIcon,
    color: 'bg-pink-500',
  ...
  // == IMAGE API TOOLS ==
  {
    ...
    description: 'remove bg instantly',
    Icon: BgRemoveIcon,
    color: 'bg-green-500',
    hoverColor: 'hover:bg-green-600',
    textColor: 'text-green-600',
...
<p>We wish all SEE students the very best of luck with their results!</p>`,
    ...
    author: 'The PDF Bullet Team',
    authorImage: '/logo.svg',
    tags: ['SEE Result', 'Class 10', 'Education', 'Nepal', 'Result 2082'],
  },
];
export const toolSeoDescriptions: { [key: string]: string } = {
  ...
  'pdf-to-pdfa': 'Transform your PDF to PDF/A, the ISO-standardized version of PDF for long-term archiving.',
