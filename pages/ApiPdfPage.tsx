...
const ApiPdfPage: React.FC = () => {
    const pdfTools = TOOLS.filter(tool => tool.api?.category === 'pdf');
            ...
            <div className="container mx-auto px-6">
                <section className="text-center max-w-4xl mx-auto">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 dark:text-gray-100">
                        A full suite of tools to optimize document processes
                    </h1>
                    <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                        Convert, optimize and organize documents with a few lines of code.
                    </p>
                </section>
