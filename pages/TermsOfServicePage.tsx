...
const TermsOfServicePage: React.FC = () => {
    ...
    useEffect(() => {
        document.title = "Terms and Conditions | I Love PDFLY";
        const metaDesc = document.querySelector('meta[name="description"]');
        if (metaDesc) {
            metaDesc.setAttribute("content", "Read the Terms and Conditions for using I Love PDFLY. Learn about your rights and responsibilities when using our free online PDF tools.");
        }
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <main ref={mainContentRef} className="w-full lg:w-3/4">
                         <div className="prose dark:prose-invert max-w-none">
                            ...
                            <p className="lead">Welcome to ilovepdfly.com (from this point onwards "the Service"). The Service offers its users solely a web and mobile application which allows users to manipulate documents and/or images through online software.</p>
                            ...
                            <section id="use-of-service" className="scroll-mt-24">
                                ...
                                <p>This page explains the terms by which you may use our online and/or mobile services, website, and software provided on or in connection with the service (collectively, "the Service"). By accessing or using ilovepdfly.com, you agree to be conformant to this Terms and Conditions agreement ("Agreement") whether or not you are registered on our services. In the case of disagreement with all or part of these Terms and Conditions, you should abstain from using the Service.</p>
                                ...
                                <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg text-sm my-4 not-prose">Please be nice. Don't try to hack our servers, send spam or break any other rules, regulations, or laws. We love working with you, but please don't use our Brand to do anything malicious. These are the things you just can't do.</div>
                                 ...
                                 <p>Your use of the Service and iLovePDFLY Desktop is subject to this Reasonable Use Policy, which has been created to ensure that our service is fair for both users and developers. The following is not permitted in connection with iLovePDFLY Services and Desktop App:</p>
                                  <ul>
                                    <li>Using any automated or non-automated scraping process (including bots, scrapers, and spiders) in conjunction with iLovePDFLY.</li>
                                    <li>Converting or otherwise editing documents with iLovePDFLY Desktop at a rate that exceeds what a human can reasonably do by using manual means and a conventional device.</li>
                                    <li>Providing your password to any other person or using any other person's username and password to access iLovePDFLY Desktop.</li>
                                    <li>Abusing iLovePDFLY Desktop in excess of what is reasonably needed for legitimate business or personal purposes. iLovePDFLY may investigate any account that registers over 1000 tasks in a month to determine compliance with this requirement.</li>
                                 </ul>
                                 <p>If iLovePDFLY determines that you are in breach of this policy, we may temporarily or permanently suspend or terminate your account or your subscription to the Service.</p>
                                 
                                 <h3 id="use-of-service-cookies">1.3 Cookies</h3>
                                 <p>iLovePDFLY websites are a Software as a Service (SaaS), and use cookies, which are essential for the operations of the service and for its correct functionality. A minimal number of other non-essential cookies will be placed under your consent. In case you do not accept, manage or reject the use of cookies, consent will be granted by using our software; yet you can give or withdraw consent to these from our <a href="/#/cookies-policy">Cookie Policy</a> page anytime.</p>
                            </section>
                            
                            <section id="accounts" className="scroll-mt-24">
                                 <h2>2. Accounts</h2>
                                <h3 id="accounts-general">2.1 General</h3>
                                <p>iLovePDFLY gives the user access to the services and functionality that we may establish and maintain from time to time and in our sole discretion. We may maintain different types of accounts for different types of Users. The different account types allow the user to work within different file size and file number limitations. Our Service users' types are as follows:</p>
                                <ul>
                                    <li>Not registered</li>
                                    <li>Registered</li>
                                    <li>Premium</li>
                                </ul>
                                <p>User is solely responsible for the activity that occurs on his account and must keep his account password secure. iLovePDFLY owns the right to totally or partially stop providing any of its Services whenever it considers it appropriate and would only give prior notification to Premium Users. In the previous operations, the corresponding taxes will be applied to the Users, assuming payment whomsoever, in conformity with the current regulation, is considered a passive subject of these operations.</p>
                            ...
                            <section id="user-content" className="scroll-mt-24">
                                ...
                                <p>iLovePDFLY does not analyse the content of files whilst processing them and only Users will have access to the edited files once iLovePDFLY has processed them. If chosen by the user, this link can be shared with someone else. iLovePDFLY will automatically delete processed files from their servers after a defined period of time depending on the tool used:</p>
                                ...
                                <p>Users bear the sole responsibility for the usage of their own files. iLovePDFLY is limited to offer users access to their own processed files. These files will only remain stored on our servers during the time that the download link is available.</p>
                            </section>
                            
                            <section id="signature" className="scroll-mt-24">
                                <h2>4. Signature</h2>
                                <h3 id="signature-how-it-works">4.1 How it works</h3>
                                <p>iLovePDFLY Signature permits documents to be signed electronically by signatory's self or one can request for signatures from other signatories by means of email delivery. Signatory has two electronic signature options:</p>
                                <ul>
                            ...
                            <section id="paid-services" className="scroll-mt-24">
                                ...
                                <p>This offer (the "Offer"), which is made to you by iLovePDFLY (as defined in the iLovePDFLY Terms and Conditions of Use), entitles you access to the iLovePDFLY Premium Service (as defined in the iLovePDFLY Terms and Conditions of Use) for a period of seven (7) days from the moment that you activate such trial period by submitting your payment details (the "Free Trial Period"). By submitting your payment details, (i) you accept the Offer, (ii) consent to us using your payment details in accordance with our Privacy Policy, (iii) acknowledge and agree to iLovePDFLY Terms and Conditions of Use and these Offer Terms and Conditions.</p>
                            </section>

                            <section id="no-warranty" className="scroll-mt-24">
                                <h2>6. No warranty</h2>
                                <h3 id="no-warranty-general">6.1 General</h3>
                                <p>Use of the service is at your own risk. To the maximum extent permitted by applicable law, the service is provided without warranties of any kind. iLovePDFLY does not warrant that the service will meet your requirements; that the service will be available at any particular time or location, uninterrupted or secure; that any defects or errors will be corrected; or that the service is free of viruses or other harmful components.</p>
                            </section>

                            <section id="liability-limitation" className="scroll-mt-24">
                                <h2>7. Limitation of liability</h2>
                                <h3 id="liability-limitation-general">7.1 General</h3>
                                <p>To the maximum extent permitted by applicable law, in no event shall iLovePDFLY or its employees be liable for any direct, indirect, punitive, incidental, special, consequential or exemplary damages, including without limitation damages for use, data or other intangible losses, arising from or relating to any breach of this agreement. Under no circumstances will iLovePDFLY be responsible for any damage, loss or injury resulting from hacking, tampering or other unauthorized access or use of the service or your account or the information contained therein.</p>
                            </section>
