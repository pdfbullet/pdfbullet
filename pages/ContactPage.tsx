...
const ContactPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = "Contact Us | I Love PDFLY Support";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
        metaDesc.setAttribute("content", "Get in touch with the I Love PDFLY team. Contact us for support, suggestions, or any questions you have about our free online PDF tools.");
    }
  }, []);
        ...
        <div className="max-w-5xl mx-auto mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 p-6 rounded-lg shadow-md flex items-center gap-4 border-glow-hover">
                 ...
                 <div>
                    ...
                    <a href="mailto:Support@ilovepdfly.com" className="text-brand-red hover:underline">
                        Support@ilovepdfly.com
                    </a>
                 </div>
            </div>
