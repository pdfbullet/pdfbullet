...
import ToolSelectionModal from '../components/ToolSelectionModal.tsx';
...
const DeviceStorageCard: React.FC<{ os: 'ios' | 'android' | 'other'; onClick: () => void; }> = ({ os, onClick }) => {
    const isIOS = os === 'ios';
    ...
    return (
        <div className="bg-white dark:bg-black p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-800">
            ...
            <button onClick={onClick} className="w-full flex items-center justify-center gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 font-semibold text-gray-700 dark:text-gray-200 transition-colors">
...
const PwaStoragePage: React.FC = () => {
    ...
    return (
        <div className="p-4 sm:p-6 space-y-8">
            <ToolSelectionModal files={selectedFiles} isOpen={isToolModalOpen} onClose={() => setIsToolModalOpen(false)} />
            ...
            <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <DeviceStorageCard os={os} onClick={handleDeviceFileClick}/>
                </div>
                <input
                    type="file"
                    ref={fileInputRef}
